...
export const DepartmentManagementTable: FC<DepartmentManagementTableProps> = ({
  ...
  const formData = {
    ...
    headOfDepartment: currentDepartment?.description || '',
    email: currentDepartment?.id || '',
    phone: currentDepartment?.name || '',
    location: currentDepartment?.name || '',
    active: currentDepartment?.name || true
  };
  ...
  const handleOpenEditModal = (department: SelectDepartment) => {
    console.log('Mock: Open edit modal', department);
  };

  const handleOpenDeleteModal = (department: SelectDepartment) => {
